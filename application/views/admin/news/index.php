		...
		<table class="sTable mTable myTable" id="checkAll" width="100%" cellspacing="0" cellpadding="0">
					...
					<form class="list_filter form" action="<?php echo admin_url('news') ?>" method="get">
						<table width="80%" cellspacing="0" cellpadding="0">
							<tbody>
								...
								<tr>
									<td class="label" style="width:50px;"><label for="filter_id">Mã số</label></td>
									<td class="item"><input name="id" value="<?php echo $this->input->get('id') ?>" id="filter_id" style="width:55px;" type="text"></td>
									
									<td class="label" style="width:60px;"><label for="filter_id">Tiêu đề</label></td>
			...
			<tbody class="list_item">
			    ...
			    <tr class="row_9">
					...
					<td class="textR" style="width: 150px">
					   <?php echo get_date($row->created) ?>
					</td>
					
					<td class="option textC" style="width: 100px">
						
						<a href="" title="Xem chi tiết" class=tipS>
