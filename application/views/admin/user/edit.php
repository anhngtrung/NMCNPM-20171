		...
		<form class="form" id="form" action="" method="post" accept-charset="utf-8" enctype="multipart/form-data">
			<fieldset>
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo"><input name="id" id="param_id" _autocheck="true" type="text" value="<?php echo $info->id ?>"></span>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo"><input name="birthday" id="param_birthday" _autocheck="true" type="text" value="<?php echo $info->birthday ?>"></span>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo"><input name="country" id="param_country" _autocheck="true" type="text" value="<?php echo $info->country ?>"></span>
						<span name="name_autocheck" class="autocheck"></span>
