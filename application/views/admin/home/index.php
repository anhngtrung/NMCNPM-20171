...
<div class="oneTwo">
	<div class="widget">
		...
		<table class="sTable myTable" width="100%" cellspacing="0" cellpadding="0">
			<tbody>
					<tr>
						<td class="fontB blue f13">Tổng giao dịch</td>
						<td class="textR webStatsLink red" style="width:120px;">136</td>
					</tr>
				    
				    <tr>
							<td class="fontB blue f13">Giao dịch hôm nay</td>
							<td class="textR webStatsLink red" style="width:120px;">0</td>
					</tr>
					
				    <tr>
							<td class="fontB blue f13">Giao dịch theo tháng</td>
	...
	<div class="widget">
		...
		<table class="sTable myTable" width="100%" cellspacing="0" cellpadding="0">
			<tbody>				
				...
				<tr>
					<td>
						<div class="left">Tổng số thiết bị</div>
				...
				<tr>
					<td>
						<div class="left">Tổng số đăng ký mượn thiết bị</div>
