		...
		<fieldset>
			<div class="widget">
			    <div class="title">
					...
					<h6>Cập nhật thông tin Thiết bị</h6>
				</div>
			    ...
			    <div class="tab_container">
				    <div class="tab_content pd0" id="tab1" style="display: block;">
				    	...
				    	<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input type="text" _autocheck="true" id="param_id" name="id" value="<?php echo $equipment->id ?>">
								</span>
				        ...
				        <div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><input type="text" _autocheck="true" id="param_name" name="name" value="<?php echo $equipment->name ?>"></span>
								<span class="autocheck" name="name_autocheck"></span>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<div class="left">
						    		...
						    		<img src="<?php echo base_url('upload/equipment/'.$equipment->image_link) ?>" alt="" style="height: 50px; margin: 5px">
								</div>
						...
						<?php $image_list = json_decode($equipment ->image_list)?>
						<div class="formRow">
							...
							<div class="formRight">
								<div class="left">
						    		...
						    		<img src="<?php echo base_url('upload/equipment/'.$img) ?>" alt="" style="height: 50px; margin: 5px;">
						    		<?php endforeach; ?>
						    	<?php endif ?>
								</div>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input type="text" _autocheck="true" class="format_number" id="param_count" style="width:100px" name="count" value="<?php echo $equipment->count ?>">
						...
						<div class="formRow">
							...
							<div class="formRight">
							    <select name="school"  class="left" >
							    	<option value="<?php echo $equipment->school ?>"><?php echo $equipment->school ?></option>}
							    	option
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span>
									<input type="text" class="format_number" id="param_date_of_manufacture" style="width:100px" name="date_of_manufacture" value="<?php echo $equipment->date_of_manufacture ?>">
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input type="text" _autocheck="true" id="param_guarantee" name="guarantee" value="<?php echo $equipment->guarantee ?>">
								</span>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneFour">
									<input type="text" id="param_unit " name="unit" value="<?php echo $equipment->unit ?>">
								</span>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<textarea cols="" rows="4" id="param_status" name="status"> <?php echo $equipment->status ?></textarea>
								</span>
